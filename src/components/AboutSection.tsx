    ...
    <section id="about" className="mx-auto max-w-6xl px-6 py-24">
      ...
      <div className="mt-3 grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        <div className="h-fit rounded-2xl border border-slate-800 bg-slate-900/50 p-6">
          <h3 className="text-sm font-semibold uppercase tracking-widest text-slate-500">Interests</h3>
          ...
          <div className="mt-8 border-t border-slate-800 pt-6">
            <h4 className="text-sm font-semibold uppercase tracking-widest text-slate-500">Currently exploring</h4>
          ...
          <div className="mt-8 border-t border-slate-800 pt-6">
            <h4 className="text-sm font-semibold uppercase tracking-widest text-slate-500">Based in</h4>
            <p className="mt-3 text-sm text-slate-400">San Francisco, CA, United States</p>
          </div>
        </div>
      </div>
