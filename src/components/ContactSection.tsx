  ...
  return (
    <section id="contact" className="mx-auto max-w-6xl px-6 py-24">
      <div className="rounded-3xl border border-slate-800 bg-slate-900/50 p-8 md:p-10">
        <p className="text-sm font-medium tracking-widest text-cyan-400">CONTACT</p>

        <h2 className="mt-3 text-3xl font-semibold text-white md:text-4xl">Let's have a coffee chat! ☕</h2>
